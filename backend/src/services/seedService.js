...
const demoCitizens = [
  { fullName: 'Jean Uwimana', email: 'jean@smartcitizen.rw', phone: '+250 788 456 111', gender: 'Female', province: 'Kigali City', district: 'Gasabo', sector: 'Kacyiru' },
  { fullName: 'Aline Umutoni', email: 'aline@smartcitizen.rw', phone: '+250 788 456 112', gender: 'Female', province: 'Kigali City', district: 'Gasabo', sector: 'Remera' },
  { fullName: 'Eric Habimana', email: 'eric.h@smartcitizen.rw', phone: '+250 788 456 113', gender: 'Male', province: 'Kigali City', district: 'Nyarugenge', sector: 'Nyarugenge' },
  { fullName: 'Diane Ingabire', email: 'diane@smartcitizen.rw', phone: '+250 788 456 114', gender: 'Female', province: 'Kigali City', district: 'Gasabo', sector: 'Kimironko' },
  { fullName: 'Emmanuel Nkurunziza', email: 'emmanuel@smartcitizen.rw', phone: '+250 788 456 115', gender: 'Male', province: 'Kigali City', district: 'Kicukiro', sector: 'Kicukiro' },
  { fullName: 'Grace Mukamana', email: 'grace@smartcitizen.rw', phone: '+250 788 456 116', gender: 'Female', province: 'Kigali City', district: 'Gasabo', sector: 'Kacyiru' }
];
...
].map((staff) => ({ ...staff, province: 'Kigali City', district: 'Gasabo', sector: 'Kacyiru' }));
...
].map((admin) => ({ ...admin, province: 'Kigali City', district: 'Gasabo', sector: 'Kacyiru' }));
...
const caseTemplates = [
  ...
  { citizen: 4, category: 'service-delay', description: 'I visited the sector office three times for a small business permit and each time I was told to come back later.', cell: 'Kagugu', village: 'Nyabisindu', status: 'Waiting for Citizen', priority: 'Medium', daysAgo: 6 },
  ...
  { citizen: 3, category: 'documents', description: 'I need a certified copy of my land ownership document but the online portal keeps rejecting my upload.', cell: 'Kibagabaga', village: 'Nyabisindu', status: 'In Review', priority: 'Medium', daysAgo: 3 },
  ...
  { citizen: 2, category: 'infrastructure', description: 'Street lighting along the main road has been off for two weeks, creating safety concerns at night.', cell: 'Nyarugenge', village: 'Nyabugogo', status: 'In Review', priority: 'High', daysAgo: 4 },
  { citizen: 4, category: 'infrastructure', description: 'A pothole on the feeder road has grown large enough to damage motorbikes and cause accidents.', cell: 'Kagugu', village: 'Nyabisindu', status: 'Resolved', priority: 'High', daysAgo: 10, resolvedDaysAgo: 2 },
  ...
  { citizen: 3, category: 'safety-community', description: 'Unlit alleyway near the school has become a security risk for children walking home in the evening.', cell: 'Kibagabaga', village: 'Nyabisindu', status: 'Assigned', priority: 'High', daysAgo: 1 },
  ...
  { citizen: 2, category: 'safety-community', description: 'A damaged fence around the construction site poses a danger to pedestrians and children in the area.', cell: 'Nyarugenge', village: 'Nyabugogo', status: 'Closed', priority: 'High', daysAgo: 15, resolvedDaysAgo: 5, closedDaysAgo: 4, rating: { score: 3, comment: 'Took a while, but the fence was eventually repaired.' } },
  ...
  { citizen: 4, category: 'misconduct', description: 'I was treated rudely and dismissed without explanation when I asked about my file status.', cell: 'Kagugu', village: 'Nyabisindu', status: 'In Review', priority: 'Critical', daysAgo: 2 },
  ...
  { citizen: 3, category: 'feedback', description: 'Suggesting that the office publishes weekly opening hours online to reduce unnecessary visits.', cell: 'Kibagabaga', village: 'Nyabisindu', status: 'Assigned', priority: 'Low', daysAgo: 1 },
  ...
  { citizen: 2, category: 'feedback', description: 'Requesting clearer signage at the entrance so first-time visitors know which counter to use.', cell: 'Nyarugenge', village: 'Nyabugogo', status: 'Resolved', priority: 'Low', daysAgo: 5, resolvedDaysAgo: 1 }
];
